...
const COMPANY_NAME = "master-lsat";
...
const GREETING_WORD = "I'm LSAT Course Assistant, How can I help you today?";
    ...
    const fetchCompanyData = async () => {
      try {
        ...
        if (data && data.length > 0) {
          ...
          setCompanyData({
            title: company.title || "LSAT Course",
            company: company.company || "master-lsat",
            category: categories, // Use the parsed categories array
            content: company.content || "",
            icon_url: company.icon_url || `/${COMPANY_NAME}/master-lsat-logo.png`
          });
        }
      } catch (error) {
        ...
        setCompanyData({
          ...
          content: "",
          icon_url: `/${COMPANY_NAME}/master-lsat-logo.png`
        });
      }
    };
