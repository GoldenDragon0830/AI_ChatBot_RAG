...
const GREETING_WORD = "I'm Nexum HC Assistant, How can I help you today?";
    ...
    const fetchCompanyData = async () => {
      try {
        ...
        if (data && data.length > 0) {
          ...
          setCompanyData({
            title: company.title || "Nexum HC",
            company: company.company || "nexum-hc",
            category: categories, // Use the parsed categories array
            content: company.content || "",
            icon_url: company.icon_url || `/${COMPANY_NAME}/nexumhc-logo.png`
          });
        }
      } catch (error) {
        ...
        setCompanyData({
          ...
          content: "",
          icon_url: `/${COMPANY_NAME}/nexumhc-logo.png`
        });
      }
    };
