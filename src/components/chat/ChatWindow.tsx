...
const COMPANY_NAME = "deli-kasbeh";
    ...
    const fetchCompanyData = async () => {
      try {
        ...
        if (data && data.length > 0) {
          ...
          setCompanyData({
            title: company.title || "Deli Kasbah",
            company: company.company || "deli-kasbeh",
            category: categories, // Use the parsed categories array
            content: company.content || "",
            icon_url: company.icon_url || `/${COMPANY_NAME}/deli-kasbah-logo.png`
          });
        }
      } catch (error) {
        ...
        setCompanyData({
          ...
          content: "",
          icon_url: `/${COMPANY_NAME}/deli-kasbah-logo.png`
        });
      }
    };
