...
const GREETING_WORD = "I'm Tomko Assistant, How can I help you today?";
    ...
    const fetchCompanyData = async () => {
      try {
        ...
        if (data && data.length > 0) {
          ...
          setCompanyData({
            title: company.title || "Kosher groceries for less",
            company: company.company || "kosher",
            category: categories, // Use the parsed categories array
            content: company.content || "",
            icon_url: company.icon_url || `/${COMPANY_NAME}/tomko-logo.png`
          });
        }
      } catch (error) {
        ...
        setCompanyData({
          title: "Kosher groceries for less",
          company: "kosher",
          category: ["Medical Waste", "Waste Disposal"],
          content: "",
          icon_url: `/${COMPANY_NAME}/tomko-logo.png`
        });
      }
    };
