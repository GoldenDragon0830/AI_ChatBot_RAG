    ...
    >
      ...
      <div style={{display: 'flex', alignItems: 'center', }}>
        <Badge
          ...
          color="success"
        >
          { isRequest ? (<PersonIcon fontSize="large" color="primary" />) : (<div style={{display: 'flex', alignItems: 'center'}}><img src="/nexum-hc/nexumhc-logo.png" alt="logo" style={{width: "60px", height: "50px"}}/></div>)}
        </Badge>
        {
